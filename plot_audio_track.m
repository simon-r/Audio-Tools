...
% [ h ] = plot_audio_track( Y , FS , varargin )
%   Plot the track and enable an easy to use player.
%   args.:
%   Y: Audio track [samples by channel] vector
%   FS: sampling freq.
%   Optional parameter 
%   add_clipping: show the clipping point generated by the function
%                   detect_clipping
%   add_silence:  show the silece region generated by the function
%                   detect_silence
%   example:
